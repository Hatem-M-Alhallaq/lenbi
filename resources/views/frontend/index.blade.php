        ...
        <div class="container">
            ...
            <div class="action d-flex align-items-center">
                ...
                <div class="dropdown user-dropdown d-none">
                    <a href="#!" class="dropdown-toggle mr-md-4 mr-3" type="button" id="triggerId" data-toggle="dropdown"
                ...
                <div class="col-xl-5 col-md-8">
                    <div class="form-contetnt pt-lg-5" data-aos="fade-up" data-aos-delay="3000">
                        <div class="form-box p-lg-4">
                            <form action="{{route('frontend.register')}}" method="post" class="needs-validation" novalidate>
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="full_name" class="form-control" placeholder="שם:" required>
                        ...
                        <p class="text-dark mt-4 text-center mb-0">
                            פרטי החשבון נועדו לניהול החשבון בתוך המערכת, והם לא חייבים להיות אותם פרטי עסק/חברה שדרושה עבורה
                            התכנית העסקית. ניתן תחת אותו חשבון ליצור יותר מתכנית אחת.
                        </p>
                    </div>
                </div>
            </div>

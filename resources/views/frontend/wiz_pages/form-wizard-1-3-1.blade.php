            ...
            <div class="container">
                ...
                <div class="form-contetnt pt-lg-5" data-aos="fade-up">
                    <div class="form-wizard">
                        <form action="{{ route('phase3a.store') }}" method="post" class="needs-validation" novalidate>
                         @csrf
                            <input type="hidden" name="app_id" value="{{$app_id}}">
                            <input type="hidden" name="credit_history" value="0">
                            <div class="row justify-content-center">
                                <div class="col-xl-6 col-lg-8 col-md-10">
                                    <div class="form-group form-question text-center mb-5">
                                        ...
                                        <h2 class="wizard-info">האם היו לך או לעסק קודם שהיה בבעלותך החזרות שיקים מסיבת אין כיסוי מספיק ב- 12 החודשים האחרונים ?</h2>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="modal-body">
                        <div class="text-center form-wizard">
                            ...
                            <div class="d-flex justify-content-center mt-4">
                                <a href="{{route('phase3b.index',compact('app_id'))}}" class="btn btn-primary mr-4 ">כן</a>
